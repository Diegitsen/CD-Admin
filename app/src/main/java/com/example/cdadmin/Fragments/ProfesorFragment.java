 ...
 */
public class ProfesorFragment extends Fragment implements Response.Listener<JSONObject>,
    ...
    //layout
    private EditText etNombre, etApellido, etMinisterio;
    Button bRegistrar;
    //for service
    ...
    private void cargarWebService()
    {
        ...
        String url = "http://192.168.0.14/CapacitacionDestino/wsJSONRegistroProfesor.php?nombre=" + etNombre.getText().toString() +
