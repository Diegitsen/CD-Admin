 ...
 */
public class CursoFragment extends Fragment implements Response.Listener<JSONObject>,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_curso, container, false);

        etUsuario = vista.findViewById(R.id.etUsuario);
        etContrasenia = vista.findViewById(R.id.etContrasenia);

        bLogin = vista.findViewById(R.id.bLogin);
    ...
    public void onErrorResponse(VolleyError error) {
        ...
        progressDialog.hide();
        Toast.makeText(getContext(), "No se pudo logear" + error.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void onResponse(JSONObject response) {
        ...
        {
            Toast.makeText(getActivity(), "Se logeo ", Toast.LENGTH_SHORT).show();
        }
        else
            Toast.makeText(getActivity(), "no Se logeo ", Toast.LENGTH_SHORT).show();
